...
apk_results = "data/test-results.csv"
all_apk_results = "results/all-test-results.csv"
apk_fail_counts = "data/fail-counts.csv"
all_apk_fail_counts = "results/all-fail-counts.csv"
apk_findings = "data/findings.csv"
all_apk_findings = "results/all-findings.csv"
apk_permissions = "data/permissions.csv"
all_apk_permissions = "results/all-permissions.csv"
